...
import type {Command} from 'wenay-common2'
...
import {Scale} from 'wenay-common2'
const {createAuthority} = Scale
type ScaleDurableLine = Scale.ScaleDurableLine
import {openFsReplayStorage} from 'wenay-common2/server/fs'
import {createRateWindow} from 'wenay-common2'
import {cloneStoreValue} from 'wenay-common2/observe'
...
if (require.main == module) {
    import('./service.js').then(function runAroundService({serviceDefinition}) {
