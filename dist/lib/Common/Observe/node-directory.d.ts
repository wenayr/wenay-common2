...
export declare function createNodeDirectory<S extends NodeDirectoryState = NodeDirectoryState>(deps?: NodeDirectoryDeps<S>): {
    api: StoreReplayRemote<NodeDirectoryState> | null;
    control: {
...
export declare function followNodeDirectory(remote: StoreReplayRemote<NodeDirectoryState>, opts?: FollowNodeDirectoryOpts): {
    nodes: () => NodeDirectoryView[];
    ...
    isStale: () => boolean;
    api: {
        get: import("./store").StoreGetter<NodeDirectoryState>;
        ...
        })) & import("./store-replay").StoreReplayState<NodeDirectoryState>;
    };
    store: Store<NodeDirectoryState>;
    close: () => void;
};
...
export declare function directoryReplicaOffers<T extends object = any>(deps: DirectoryReplicaOffersDeps<T>): {
    api: {
