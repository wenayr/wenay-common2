...
export declare function createServiceLeaderHost<D extends tServiceDefinition<any, any>>(deps: LeaderProcessDeps<D>): Promise<{
    leader: {
        secrets: {
            nodeToken: string;
            tokenSecret: string;
        ...
        line: {
            control: {
                store: import("../Common/Observe").Store<import("./definition").tDefinitionState<D>>;
                addOffer: (offerValue: import("../Common/Observe").StoreReplicaOffer<import("./definition").tDefinitionState<D>>) => () => void;
                removeOffer: (id: string) => boolean;
                setOffers: (next: readonly import("../Common/Observe").StoreReplicaOffer<import("./definition").tDefinitionState<D>>[]) => void;
                probe: () => Promise<void>;
            ...
            api: {
                ...
                conflicts: import("..").ListenApi<[import("../Common/Observe").StoreReplicaConflict<import("./definition").tDefinitionState<D>>]>;
                ...
                fragment: {
                    ...
                    })) & import("../Common/Observe").StoreReplayState<import("./definition").tDefinitionState<D>>;
                    ping: () => number;
                };
                canWrite: () => boolean;
            };
        ...
        corridor: {
            execute: <K extends (keyof import("./definition").tDefinitionCommands<D> & string) & string>(account: string, command: K, requestId: string, input: Parameters<{ [K_1 in keyof import("./definition").tDefinitionCommands<D> & string]: (ctx: import("../Common/command/command-host").CommandCtx, input: Parameters<import("./definition").tDefinitionCommands<D>[K_1]["apply"]>[1]) => ReturnType<import("./definition").tDefinitionCommands<D>[K_1]["apply"]>; }[K]>[1]) => Promise<Awaited<ReturnType<{ [K_1 in keyof import("./definition").tDefinitionCommands<D> & string]: (ctx: import("../Common/command/command-host").CommandCtx, input: Parameters<import("./definition").tDefinitionCommands<D>[K_1]["apply"]>[1]) => ReturnType<import("./definition").tDefinitionCommands<D>[K_1]["apply"]>; }[K]>>>;
            names: (keyof import("./definition").tDefinitionCommands<D> & string)[];
            fragment: (account: string) => import("../Common/command/command-host").CommandFragment<{ [K_1 in keyof import("./definition").tDefinitionCommands<D> & string]: (ctx: import("../Common/command/command-host").CommandCtx, input: Parameters<import("./definition").tDefinitionCommands<D>[K_1]["apply"]>[1]) => ReturnType<import("./definition").tDefinitionCommands<D>[K_1]["apply"]>; }>;
            byToken: () => import("../Common/command/command-token").CommandTokenFragment<{ [K_1 in keyof import("./definition").tDefinitionCommands<D> & string]: (ctx: import("../Common/command/command-host").CommandCtx, input: Parameters<import("./definition").tDefinitionCommands<D>[K_1]["apply"]>[1]) => ReturnType<import("./definition").tDefinitionCommands<D>[K_1]["apply"]>; }>;
            system: import("../Common/command/command-host").CommandFragment<{ [K_1 in keyof import("./definition").tDefinitionCommands<D> & string]: (ctx: import("../Common/command/command-host").CommandCtx, input: Parameters<import("./definition").tDefinitionCommands<D>[K_1]["apply"]>[1]) => ReturnType<import("./definition").tDefinitionCommands<D>[K_1]["apply"]>; }>;
        };
        access: {
            ...
            publicViews: () => import("./definition").tPublicViewLines<D> | null;
        ...
        resources: {
            errors: import("..").ListenApi<[import("./resource-session").ServiceResourceDiagnostic]>;
        };
        control: {
            start: () => void;
            drain: (nodeId: string) => {
        ...
        serve: {
            browserFragment: (_account?: string) => (import("./definition").tHasViews<D> extends true ? {
                ...
                views: import("./definition").tPublicViewLines<D>;
            } : Omit<{
                replica: {
                    descriptor: () => import("../Common/Observe").StoreReplicaDescriptor;
                    changed: import("..").ListenApi<[import("../Common/Observe").StoreReplicaDescriptor]>;
            ...
            readFragment: () => (import("./definition").tHasViews<D> extends true ? {
                views: import("./definition").tPublicViewLines<D>;
            } : {
                replica: {
                    descriptor: () => import("../Common/Observe").StoreReplicaDescriptor;
            ...
            scaleConnection: () => import("../Common/scale/scale-authority").AuthorityConnection<import("./definition").tPrincipalFacade<D, import("../Common/command/command-host").CommandFragment<{ [K_1 in keyof import("./definition").tDefinitionCommands<D> & string]: (ctx: import("../Common/command/command-host").CommandCtx, input: Parameters<import("./definition").tDefinitionCommands<D>[K_1]["apply"]>[1]) => ReturnType<import("./definition").tDefinitionCommands<D>[K_1]["apply"]>; }>, () => {
                revoked: true;
                account: string;
                sessionsCut: number;
            }>>;
            resourceConnection: () => {
                ...
                attach: (control: import("..").RpcServerControl) => void;
                close: () => Promise<void>;
            };
            nodeLinkFragment: (linkNodeId?: string) => {
                ...
                commandsByToken: import("../Common/command/command-token").CommandTokenFragment<{ [K_1 in keyof import("./definition").tDefinitionCommands<D> & string]: (ctx: import("../Common/command/command-host").CommandCtx, input: Parameters<import("./definition").tDefinitionCommands<D>[K_1]["apply"]>[1]) => ReturnType<import("./definition").tDefinitionCommands<D>[K_1]["apply"]>; }>;
                register(entry: {
                    nodeId?: unknown;
                    url?: unknown;
                    weight?: unknown;
            ...
            signup: (requestId: string, input: unknown) => Promise<Awaited<ReturnType<{ [K_1 in keyof import("./definition").tDefinitionCommands<D> & string]: (ctx: import("../Common/command/command-host").CommandCtx, input: Parameters<import("./definition").tDefinitionCommands<D>[K_1]["apply"]>[1]) => ReturnType<import("./definition").tDefinitionCommands<D>[K_1]["apply"]>; }[string]>>>;
        };
        view: {
            ...
            commandNames: (keyof import("./definition").tDefinitionCommands<D> & string)[];
            state: () => import("./definition").tDefinitionState<D>;
            reader: () => unknown;
        };
    };
    url: string;
...
export declare function runLeaderProcess<D extends tServiceDefinition<any, any>>(deps: LeaderProcessDeps<D>): Promise<{
    leader: {
        secrets: {
            nodeToken: string;
            tokenSecret: string;
