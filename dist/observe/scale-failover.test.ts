...
//  control line (directory, deny list, receipts); when the leader dies
//  it takes over — the roster continues, revocations still bite, and an OLD
//  requestId answers its receipt instead of running again (deduplication across
//  this in-process succession). A store node re-homes onto the new leader through its
