// ============================================================
//  src/server/httpFacadeOpenApi.ts  (wenay-common2/server/http)
//
//  OpenAPI 3.1.0 descriptor for a createHttpFacadeServer facade. Graduated
//  from the demo incubator once two example stands (rental, pizzeria) needed
//  the same document over the same facade objects. The route list is NOT re-derived here — the real facade
...
import type {HttpFacadeServerOptions, tHttpFacadeMethod} from './httpFacadeServer'
import {createHttpFacadeServer} from './httpFacadeServer'
import {resolveLimits, type RpcLimits} from '../Common/rcp/rpc-limits'
