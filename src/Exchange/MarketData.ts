...
import {BSearch, E_MATCH, MaxCommonDivisor, MyNumMap, ParsedUrlQueryInputMy} from "../Common/core/common";
...
export class CQuotesHistory
{
	...
	protected _GetTickSize() : number { let val=0;  for(let bars of this.barsMainMap.Values) val= MaxCommonDivisor(bars.tickSize, val);  return val; }
