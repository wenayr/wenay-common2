...
export declare function WebSocketServerHook(s: ReturnType<typeof SocketServerHook>, paramsSoc?: Parameters<typeof soc>[1], disconnect?: () => any): {
    ...
    get: {
        [k: string]: {
            callback: (z: (...args: any[]) => void, opts?: import("../..").RpcListenSubscribeOpts) => import("../..").SubscriptionHandle;
            on: (z: (...args: any[]) => void, opts?: import("../..").RpcListenSubscribeOpts) => import("../..").SubscriptionHandle;
            once: (z: (...args: any[]) => void, opts?: import("../..").RpcListenSubscribeOpts) => import("../..").SubscriptionHandle;
            close: () => void;
            off: () => boolean;
